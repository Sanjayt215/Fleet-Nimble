...
import knowledgeSyncAdminRoutes from './admin/knowledgeSync.routes.js';
import ragAdminRoutes from './admin/rag.routes.js';
...
import receptionistMultiAgentRoutes from './receptionistMultiAgent.routes.js';
import twilioReceptionistRoutes from './twilioReceptionist.routes.js';
import conversationIntelligenceRoutes from './conversationIntelligence.routes.js';
import fleetBrainRoutes from './fleetBrain.routes.js';
import businessIntelligenceRoutes from './businessIntelligence.routes.js';
...
router.use('/admin/knowledge', knowledgeSyncAdminRoutes);
router.use('/admin/rag', ragAdminRoutes);
...
router.use('/ai-receptionist', conversationIntelligenceRoutes);
router.use('/ai-receptionist', businessIntelligenceRoutes);
router.use('/ai-receptionist/multiagent', receptionistMultiAgentRoutes);
router.use('/fleet-brain', fleetBrainRoutes);
