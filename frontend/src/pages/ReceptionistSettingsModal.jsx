...
export default function ReceptionistSettingsModal({ onClose, showToast, embedded }) {
  ...
  const content = loading ? (
    ...
    <form onSubmit={handleSubmit} className="space-y-4 px-6 py-4">
      ...
      <div className="flex justify-end gap-3 border-t border-slate-700 pt-4">
        {!embedded && <button type="button" onClick={onClose} className="btn-secondary">Cancel</button>}
